...
from processor import ImageLabel,make_weights_for_balanced_classes, load_data
...
if __name__ == "__main__":
    ...
    trn,val = load_data()
    train_dataset = ImageLabel(root=DATA_PATH,df=trn)
    #val_dataset = ImageLabel(root=DATA_PATH,df=val,transform=val_transforms)
    weight = make_weights_for_balanced_classes(train_dataset.labels,settings.nc)
