...
### [项目官方网址](https://www.flyai.com/d/RespiratorySound)
...
>         pass
>
>     def output_x(self, audio_and_txt_files_path, patient_id, age, sex, adult_bmi, child_weight, child_height):
>          '''
>     	参数为csv中作为输入x的一条数据，该方法会被dataset.next_train_batch()
