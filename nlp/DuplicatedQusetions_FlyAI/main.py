...
from processor import DQuestionFlyAI
...
data = Dataset()
model = Model(data)
train_dataset = DQuestionFlyAI(root=DATA_PATH,df=data.db.source.data)
val_dataset = DQuestionFlyAI(root=DATA_PATH,df=data.db.source.test)
