...
from net import Net, LSTMNet,FCNet,GRUNet
...
net = GRUNet()
#net = BertForSequenceClassification.from_pretrained('bert-base-uncased', num_labels=settings.nc)
...
#optimizer = Adam(
#    [
#        {"params":net.bert.parameters(),"lr": 0.00001},
