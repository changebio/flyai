...
class Processor(Base):
    ...
    def input_x(self, question, answer):
        ...
        '''
        word_list1 = words2vec(question,self.vocab,self.embedding_len,self.max_sts_len)
        word_list2 = words2vec(answer,self.vocab,self.embedding_len,self.max_sts_len)
